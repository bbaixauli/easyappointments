...
// Spanish
$lang['page_title'] = 'Solicitar una cita con';
$lang['step_one_title'] = 'Seleccione Servicio y Técnico';
$lang['select_service'] = 'Seleccione Servicio';
$lang['select_provider'] = 'Seleccione Técnico';
...
$lang['step_three_title'] = 'Introduzca su información';
$lang['first_name'] = 'Nombre';
$lang['last_name'] = 'Apellido';
$lang['email'] = 'Dirección de E-mail';
$lang['email_book_hint'] = 'Se utiliza para enviar confirmaciones y notificaciones y permite modificar la cita';
$lang['phone_number'] = 'Número de teléfono';
$lang['phone_number_book_hint'] = 'Indique los 9 dígitos. Si tiene, indique su teléfono móvil personal';
...
$lang['cancel_appointment_hint'] = 'Presione el botón "Cancelar" para eliminar la cita.';
$lang['cancel'] = 'Cancelar';
$lang['appointment_registered'] = 'Su cita ha sido registrada con éxito';
$lang['cancel_appointment_title'] = 'Cancelar cita';
$lang['appointment_cancelled'] = 'Su cita ha sido cancelada con éxito';
$lang['appointment_cancelled_title'] = 'Cita cancelada';
$lang['reason'] = 'Razón';
$lang['appointment_removed_from_schedule'] = 'Se eliminó esta cita.';
...
$lang['appointment_booked'] = 'Su cita ha sido realizada con éxito';
$lang['thank_you_for_appointment'] = 'Gracias por utilizar nuestro servicio para solicitar su cita.  Debajo encontrará los detalles de su cita. Haga clic en la cita para realizar cambios.';
$lang['appointment_details_title'] = 'Detalles de la cita';
$lang['customer_details_title'] = 'Detalles del cliente';
$lang['service'] = 'Servicio';
$lang['provider'] = 'Técnico';
...
$lang['appointment_added_to_your_plan'] = 'Se ha reservado una nueva cita en su calendario.';
...
$lang['manage_appointment_record_hint'] = 'Gestionar todas las citas de los técnicos y servicios disponibles.';
$lang['select_filter_item_hint'] = 'Seleccionar un técnico o un servicio y ver las citas en el calendario.';
$lang['enable_appointment_sync_hint'] = 'Habilitar la sincronización de la cita con la cuenta de Google Calendar del técnico.';
$lang['manage_customers_hint'] = 'Gestionar los clientes registrados y ver su historial de citas.';
$lang['manage_services_hint'] = 'Gestionar los servicios y las categorías disponibles del sistema.';
$lang['manage_users_hint'] = 'Gestionar usuarios internos (administradores, técnicos, asistentes).';
$lang['settings_hint'] = 'Establecer configuración de sistema y usuario.';
$lang['log_out_hint'] = 'Cerrar sesión del sistema.';
$lang['unavailable_periods_hint'] = 'El técnico no podrá aceptar nuevas citas cuando se encuentre como No disponible.';
...
$lang['download_appointments_hint'] = 'Descargar citas a Excel.';
...
$lang['appointment_changes_saved'] = 'Se han guardado con éxito los cambios en la cita';
$lang['save'] = 'Guardar';
$lang['new'] = 'Nuevo';
$lang['select'] = 'Seleccionar';
$lang['hide'] = 'Ocultar';
$lang['type_to_filter_customers'] = 'Escriba para filtrar clientes.';
$lang['clear_fields_add_existing_customer_hint'] = 'Limpiar los campos e introducir un nuevo cliente.';
...
$lang['write_appointment_removal_reason'] = 'Por favor, inserte una razón para borrar la cita:';
$lang['appointment_saved'] = 'Cita guardado con éxito';
$lang['new_unavailable_title'] = 'Nuevo periodo No disponible';
$lang['edit_unavailable_title'] = 'Editar periodo No disponible';
$lang['unavailable_saved'] = 'Periodo No disponible guardado con éxito';
$lang['start_date_before_end_error'] = 'La fecha del inicio es posterior a la fecha del final';
$lang['invalid_email'] = 'Dirección de E-mail no válida';
$lang['invalid_phone_number'] = 'Teléfono no válido (introduzca únicamente 9 dígitos)';
...
$lang['providers'] = 'Técnicos';
$lang['secretaries'] = 'Secretarias';
$lang['mobile_number'] = 'Número de teléfono móvil';
$lang['state'] = 'Estado';
$lang['username'] = 'Nombre de usuario';
$lang['password'] = 'Contraseña';
$lang['retype_password'] = 'Vuelva a introducir su contraseña';
$lang['receive_notifications'] = 'Recibir notificaciones';
$lang['passwords_mismatch'] = 'Las contraseñas no coinciden';
$lang['admin_saved'] = 'Administrador guardado con éxito';
$lang['provider_saved'] = 'Técnico guardado con éxito';
$lang['secretary_saved'] = 'Asistente guardado con éxito';
$lang['admin_deleted'] = 'Administador eliminado con éxito';
$lang['provider_deleted'] = 'Técnico eliminado con éxito';
$lang['secretary_deleted'] = 'Asistente eliminado con éxito';
$lang['service_saved'] = 'Servicio guardado con éxito';
$lang['service_category_saved'] = 'Categoría de servicio guardada con éxito';
$lang['service_deleted'] = 'Servicio eliminado con éxito';
$lang['service_category_deleted'] = 'Categoría de servicio eliminada con éxito';
$lang['customer_saved'] = 'Cliente guardado con éxito';
$lang['customer_deleted'] = 'Cliente eliminado con éxito';
...
$lang['add_breaks_during_each_day'] = 'Agregar periodos de descanso para cada día. Durante los periodos de descanso los técnicos no podrán aceptar ninguna cita.';
$lang['day'] = 'Día';
$lang['days'] = 'Days';
...
$lang['go_to_booking_page'] = 'Ir a la página de citación';
$lang['settings_saved'] = 'Configuración guardada con éxito';
$lang['general'] = 'General';
$lang['business_logic'] = 'Lógica del negocio';
$lang['current_user'] = 'Usuario actual';
$lang['about_app'] = 'Acerca de Easy!Appointments';
$lang['edit_working_plan_hint'] = 'Marque abajo los días y horarios en que su empresa aceptará citas. Será posible reservar citas fuera del horario de trabajo, pero los clientes no podrán solicitar citas ellos mismos en esos horarios.  Este será el esquema del horario laboral por defecto para todos los nuevos técnicos registrados, pero podrá cambiar el esquema de cada técnico editando su registro. Luego se podrá agregar periodos de descanso.';
$lang['edit_breaks_hint'] = 'Agregar los periodos de descanso de trabajo en cada día. Se aplicarán estos periodos de descanso para todos los nuevos técnicos.';
$lang['book_advance_timeout'] = 'Definir tiempos muertos';
$lang['book_advance_timeout_hint'] = 'Defina el tiempo muerto (en minutos) antes que de los clientes puedan solicitar o reorganizar sus citas.';
$lang['timeout_minutes'] = 'Tiempo muerto (en minutos)';
$lang['book_max_days'] = 'Definir antelación máxima para pedir cita';
$lang['book_max_days_hint'] = 'Defina los días de antelación en los que los clientes pueden solicitar una citas (0 -> sin limitación).';
$lang['max_days'] = 'Días de antelación (0 -> sin límite)';
$lang['hide_provider'] = 'Selección de técnicos en la petición de cita';
$lang['only_any_provider'] = 'No mostrar la selección de técnicos en la petición de cita';
$lang['only_any_provider_hint'] = 'Seleccione para no mostrar los técnicos en la petición de cita (se utilizará cualquier técnico)';
$lang['about_app_info'] = 'Easy!Appointments es un aplicativo web completamente personalizable que le permitirá a sus clientes reservar citas con Usted a través de Internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
...
$lang['logout_success'] = 'Usted ha cerrado su sesión con éxito. Haga clic en uno de los siguientes botones para navegar hacia otra página.';
$lang['book_appointment_title'] = 'Solicitar cita';
...
$lang['enter_username_here'] = 'Introduzca su nombre de usuario aquí...';
$lang['enter_password_here'] = 'Introduzca su nombre de usuario aquí...';
$lang['login'] = 'Iniciar sesión';
$lang['forgot_your_password'] = '¿Olvidó su contraseña?';
$lang['login_failed'] = 'El inicio de sesión falló. Por favor, introduzca las credenciales correctas e inténtelo nuevamente.';
$lang['type_username_and_email_for_new_password'] = 'Introduzca su nombre de usuario y su dirección de E-mail para obtener una nueva contraseña.';
$lang['enter_email_here'] = 'Introduzca su dirección de E-mail aquí...';
...
$lang['delete_provider'] = 'Eliminar Técnico';
...
$lang['unavailable_updated'] = 'Periodo No disponible actualizado con éxito';
...
$lang['hour'] = 'Hora';
$lang['minute'] = 'Minuto';
$lang['google_sync_completed'] = 'Se completó la sincronización con Google con éxito';
...
$lang['google_calendar_selected'] = 'Se ha seleccionado el calendario de Google Calendar con éxito';
...
$lang['ea_update_success'] = 'Easy!Appointments ha sido actualizado con éxito';
...
$lang['any_provider'] = 'Cualquier Técnico';
...
$lang['legal_contents'] = 'Contenido de condiciones legales';
$lang['cookie_notice'] = 'Aviso de cookies';
$lang['display_cookie_notice'] = 'Mostrar aviso de cookies';
$lang['cookie_notice_content'] = 'Contenido de política de cookies';
...
$lang['website_using_cookies_to_ensure_best_experience'] = 'Las cookies nos permiten ofrecer nuestros servicios. Al continuar con la navegación entendemos que se acepta nuestra política de privacidad.';
$lang['learn_more'] = 'Más información.';
$lang['read_and_agree_to_terms_and_conditions'] = 'He leído y acepto los {$link}términos y condiciones{/$link}.';
$lang['read_and_agree_to_privacy_policy'] = 'He leído y estoy de acuerdo con la {$link}política de privacidad{/$link}.';
$lang['delete_personal_information_hint'] = 'Borrar toda mi información personal en el sistema.';
$lang['delete_personal_information'] = 'Borrar mi información personal';
$lang['delete_personal_information_prompt'] = '¿Estás seguro que quieres borrar toda tu información personal? Esta operación no se puede deshacer.';
